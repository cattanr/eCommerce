...
$b = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/StoreBundle/Resources/config/doctrine') => 'StoreBundle\\Entity'));
$b->setGlobalBasename('mapping');

$a->addDriver($b, 'StoreBundle\\Entity');

$instance->setEntityNamespaces(array('StoreBundle' => 'StoreBundle\\Entity'));
